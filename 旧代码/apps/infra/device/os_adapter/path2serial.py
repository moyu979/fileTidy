...
def path2serial(dev_path):
    ...
    if system == "windows":
        from .windows.path2serial import path2serial as impl
    elif system == "linux":
        from .linux.path2serial import path2serial as impl
    elif system == "macos":
        from .macos.path2serial import path2serial as impl
    else:
