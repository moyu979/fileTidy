...
def smart_check(dev_path):
    ...
    if system == "windows":
        from .windows.smart_check import smart_check as impl
    elif system == "linux":
        from .linux.smart_check import smart_check as impl
    elif system == "macos":
        from .macos.smart_check import smart_check as impl
    else:
