...
parser_init.add_argument("--db",default="./db",help="dir path to store database")

parser_add=subparsers.add_parser("add",help="add files to trace list")
parser_add.add_argument("--db",default="./db",help="path of database")
...
parser_check.add_argument("--db",default="./db",help="path of database")
...
parser_move.add_argument("--db",default="./db",help="path of database")
...
if args.command=="init":
    ...
    Add.Add(args.db,args.files,args.writeOrigin,args.checkExist,True)
