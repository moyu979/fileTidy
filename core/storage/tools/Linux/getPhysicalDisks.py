...
def get_physical_disks():
    ...
    try:
        # 获取物理磁盘列表（不含分区等）
        output = subprocess.check_output("lsblk -dn -o NAME,SIZE,TYPE --bytes", shell=True, encoding='utf-8')
        ...
        for line in lines:
            ...
            try:
                ...
                serial_match = re.search(r"ID_SERIAL_SHORT=(.+)", udevadm_out) or \
                               re.search(r"ID_SERIAL=(.+)", udevadm_out)
