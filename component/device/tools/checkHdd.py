...
def check_hdd(device, scan_blocks=False):
    """
    ...
    if system == "windows":
        from .windows.checkHdd import hdd_check as impl
    elif system == "linux":
        from .linux.checkHdd import hdd_check as impl
    elif system == "macos":
        from .macos.checkHdd import hdd_check as impl
    else:
