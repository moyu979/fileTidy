...
class test(unittest.TestCase):
    ...
    # def test_updateDelete_normalRemove(self):
    #     fileSource="./test/examples/updateDelete_normalRemove/file/delete"
    #     fileDest="./testFiles/delete"
    #     shutil.copytree(fileSource,fileDest)
    #     logSource="./test/examples/updateDelete_normalRemove/logs"
    #     logDest="./fileLogs"
    #     shutil.copytree(logSource,logDest)

    #     updateDelete.delete(fileDest,"download")

    #     ansPath="./test/examples/updateDelete_normalRemove/ans/download.txt"
    ...
    def test_writeFinal_normal_and_Nosource(self):
        filePath="./test/examples/writeFinal_normal_and_noResource/files"
        destPath="./testFiles"
        shutil.copytree(filePath,destPath)

        logSource="./test/examples/writeFinal_normal_and_noResource/logs"
        logDest="./fileLogs"
        shutil.copytree(logSource,logDest)

        writeFinal.final(destPath)

        ansPath="./test/examples/writeFinal_normal_and_noResource/ans/download.txt"
        resPath="./fileLogs/download/new.txt"
        self.assertTrue(compareFile(ansPath,resPath))

        ansPath="./test/examples/writeFinal_normal_and_noResource/ans/final.txt"
        resPath="./fileLogs/final/new.txt"
        self.assertTrue(compareFile(ansPath,resPath))
